 ...
 * @author Danny
 */
public class Player_Tank_1 extends Player_Tank {

    Player_Tank_1(Vector image, double x, double y, double deltaAngle, int maxSpeed, GameEvents event, int health, int gapBetweenFire, double acceleration) {
        this.image = image;
        this.x = x;
        this.originalX = x;
        this.y = y;
    ...
    public void update(Observable o, Object o1) {
        ...
        if (show) {
            if (ge.getType() == 1) {
                ...
                if (ge.getplayer() instanceof Player_Tank_1) {
